  ...
  return (
    <div className="shadow p-5 mb-3 flex gap-10 items-center">
        ...
        <div className="md:w-4/6">
            ...
            <p className="text-xl font-bold mt-3">Amount: {product.amount}</p>
            <p className="text-xl font-bold mt-3 text-amber-500">Price: {formatCurrent(product.price)}</p>
            <p className="text-sm font-bold mt-3">SubTotal: {formatCurrent(product.price * product.amount)}</p>
        </div>
        <div>
            <button
                type="button"
